 ...
 */
public class duplicate_registration extends javax.swing.JFrame {

    /**
     * Creates new form registration_duplicate
     */
    public duplicate_registration() {
        initComponents();
        try {
    ...
    private void initComponents() {
        ...
        jPanel1.add(txtGender, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 420, 150, 30));
        ...
        cmbplayerid.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmbplayeridActionPerformed(evt);
            }
        });
        jPanel1.add(cmbplayerid, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 90, 130, 30));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 590, 310, 50));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1080, 600, 140, 30));

        lval.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        lval.setForeground(new java.awt.Color(255, 0, 0));
        jPanel1.add(lval, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 524, 390, 40));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
            lval.setText("Mobile Number  Field is isEmpty");
        }
        else 
        {
        ...
        try {
            ...
            String search =cmbplayerid.getSelectedItem().toString();
           ...
           // st.executeUpdate("insert into register1 values ('" + PlayerId +"','"+ FirstName + "','" + MiddelName + "','" + LastName + "','" + DateOfBirth + "','" + BirthPlace + "','"+ VillageTown +"','"+ District + "','" + Pincode +"','" + State +"','"+ PermanentAddress + "','"+ CurrentAddress +"','"+ Hobbies + "','"+ Intrested +"','"+ AdmissionDate +"','"+Country+"','"+Mobilenumber1+"','"+Mobilenumber2+"')");where Coachid='"+search+"'");
            
            
            st.executeUpdate("update register1 set FirstName='"+txtfristname.getText()+"',MiddelName='"+txtmiddelname.getText()+"',LastName='"+txtlastname.getText()+"',DateOfBirth='"+txtdateofbirth.getText()+"',BirthPlace='"+txtbirthplace.getText()+"',VillageTown='"+txtvillage.getText()+"',District='"+txtdistrict.getText()+"',Pincode='"+txtpincode.getText()+"',State='"+txtstate.getText()+"',PermanentAddress='"+txtpaddress.getText()+"',CurrentAddress='"+txtcaddraess.getText()+"',Hobbies='"+txthobbies.getText()+"',Intrested='"+txtintrested.getText()+"',Gender='"+txtGender.getText()+"',AdmissionDate='"+txtadmissiondate.getText()+"',Country='"+txtcountry.getText()+"',Mobilenumber1='"+txtmobile1.getText()+"',Mobilenumber2='"+txtmobile2.getText()+ "'where PlayerId='"+search+"'");
            con.close();
        } catch (SQLException qw) {
            System.out.println(qw);
        }
    ...
    private void cmbplayeridItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cmbplayeridItemStateChanged
        // TODO add your handling code here:
          try {
            ...
            rs.next();
            txtfristname.setText(rs.getString(2));
            txtmiddelname.setText(rs.getString(3));
            txtlastname.setText(rs.getString(4));
            txtdateofbirth.setText(rs.getString(5));
            txtbirthplace.setText(rs.getString(6));
            txtvillage.setText(rs.getString(7));
            txtdistrict.setText(rs.getString(8));
            txtpincode.setText(rs.getString(9));
            txtstate.setText(rs.getString(10));
            txtpaddress.setText(rs.getString(11));
            txtcaddraess.setText(rs.getString(12));
            txthobbies.setText(rs.getString(13));
            txtintrested.setText(rs.getString(14));
            txtGender.setText(rs.getString(15));
            txtadmissiondate.setText(rs.getString(16));
            txtcountry.setText(rs.getString(17));
            txtmobile1.setText(rs.getString(18));
            txtmobile2.setText(rs.getString(19));
    ...
    private void cmbplayeridActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbplayeridActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cmbplayeridActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(duplicate_registration.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
